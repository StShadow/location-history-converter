...
├── location_history_converter             # The main python package for the project
...
e.g: `cat location_history_converter/VERSION` will get the project version without harming
